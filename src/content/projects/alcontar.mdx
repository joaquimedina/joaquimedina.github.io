...
La propuesta transformó el municipio en un espacio de encuentro, experimentación y participación, integrando artistas, vecinos, infancia, jóvenes, instituciones locales y visitantes en un proceso cultural abierto al territorio.
...
Realicé tareas de grabación, edición y documentación audiovisual del proyecto, registrando actividades, talleres, acciones escénicas y procesos participativos.
...
> documentar un proceso comunitario no consiste sólo en grabar lo que ocurre; consiste en cuidar cómo será recordado.
