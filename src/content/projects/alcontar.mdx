...
import img3 from '../../assets/images/alcontar3.webp';
import img4 from '../../assets/images/alcontar4.webp';
import img5 from '../../assets/images/alcontar5.webp';
import img6 from '../../assets/images/alcontar8.webp';
...
Realicé tareas de grabación, edición y documentación audiovisual de algunos recorridos del proyecto, registrando actividades, talleres, acciones escénicas y procesos participativos, materiales que utilicé para realizar el video promocional anterior y para ampliar el archivo documental de Vladimir Tzekov y Campo de Desconcentración Polivalente. Participé como intérprete en una representación realizada en la localidad del espectáculo de Vladimir Tzekov, Misa de Réquiem nº8: La Peste, que formaba parte del proyecto así como en la organización y desarrollo de talleres creativos para infancia, introduciendo elementos básicos del lenguaje audiovisual mediante dinámicas participativas.

El objetivo no era solo producir imágenes de difusión, sino conservar parte de la experiencia vivida: los encuentros, las acciones, la relación con el espacio público y la implicación de la comunidad local.

![Taller audiovisual comunitario en Alcóntar](../../assets/images/alcontar1.webp)
...
Participé como intérprete junto a la compañía Vladimir Tzekov en la representación de **Misa de Réquiem nº8: La Peste**, una propuesta escénica desarrollada dentro del marco del proyecto.
...
![Representación escénica comunitaria en Alcóntar](../../assets/images/alcontar6.webp)
...
![Representación escénica comunitaria en Alcóntar](../../assets/images/alcontar7.webp)
...
> no solo consiste en grabar lo que ocurre; es mejor cuidar cómo será recordado.
