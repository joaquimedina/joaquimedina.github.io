...
isFeatured: true
seo:
  title: 'Campo de Desconcentración Polivalente · Arte comunitario en Alcóntar'
  description: Proyecto de arte comunitario, participación ciudadana y producción audiovisual desarrollado en Alcóntar junto al ayuntamiento y vecinos.
  image:
